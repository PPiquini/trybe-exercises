...
-- Caso o valor seja maior que o anterior, insira na coluna ticket_price_estimation o 
-- valor de 'Increasing' . Caso contrário, insira o valor 'Decreasing' . 
-- Adicionalmente, insira um novo registro na tabela movies_logs , contendo informações 
-- sobre o registro alterado ( movie_id , executed_action e log_date ).
